...
//		fila = tDatos.rowAtPoint( e.getPoint() ); //Devuelve la fila en la cual se encuentra el rat�n.
//		columna = tDatos.columnAtPoint( e.getPoint()); //Devuelve la columna en la cual se encuentra el rat�n.
//	}
