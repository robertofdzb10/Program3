...
public class VentanaLogger02 extends JFrame {
	
	private JFrame ventanaLogger;
	
	public VentanaLogger02() {
	...
	this.addWindowListener( new WindowAdapter() {
		...
		public void windowClosed(WindowEvent e) {
			MainLogger02.log.log( Level.INFO, "Fin de programa.");
		}
	});
	...
	bStart.addActionListener( new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			...
			MainLogger02.log.log( Level.FINER, "Se esta comenzando el juego.");
		}
	});
	...
	bStop.addActionListener( new ActionListener() {
		@Override
		public void actionPerformed(ActionEvent e) {
			MainLogger02.log.log( Level.FINER, "Se esta terminando el juego.");
